        ...
        <div class="search">
            <el-form ref="searchForm" v-loading="listLoading" :model="searchForm" inline>
                ...
                <el-form-item>
                    ...
                    <el-button type="primary" size="medium" @click="resetSearchData">重置</el-button>
                    <el-button type="primary" size="medium" @click="create">新增分类</el-button>
                </el-form-item>
            </el-form>
        </div>
        ...
        <div class="app-container">
            ...
            >
                ...
                <el-table-column label="评论文章" align="center">
                    <template slot-scope="scope">
                        {{ scope.row.article_info && scope.row.article_info.id }} -
                        {{ scope.row.article_info && scope.row.article_info.title }}
                    </template>
                </el-table-column>
                <el-table-column class-name="status-col" label="状态" align="center">
                    <template slot-scope="scope">
                        ...
                        >{{ scope.row.status | statusFilterText }}</el-tag>
                    </template>
                </el-table-column>
