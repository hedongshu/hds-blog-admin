    ...
    <section class="wrap">
        ...
        >
            <el-form-item label="标题" prop="title">
                <el-input v-model="ruleForm.title" @change="titleChange" />
            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        titleChange(value) {
            console.log(value)
            if (value.length > 0) {
                if (this.ruleForm.description.length == 0) this.ruleForm.description = value

                if (this.ruleForm.seo_keyword.length == 0) this.ruleForm.seo_keyword = value
            }
        },
        // 提交表单
        submitForm(formName) {
